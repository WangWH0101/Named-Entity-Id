...
AuAddata=open('/mnt/sdb/wos2018-wwh/Disambiguation/Authorship_Institution/AuthorShip_AddrDict_CS_2008to2016.pickle','rb')
...
if use_stwd==1:
	file1 =open('/mnt/sdb/wos2018-wwh/Disambiguation/Result/IND_StopWd_Threshold_'+str(THRESHOLD)+'_'+TGF+'_'+str(STY)+'to'+str(EDY)+'.pickle', 'wb')
else:
	file1 =open('/mnt/sdb/wos2018-wwh/Disambiguation/Result/IND_Threshold_'+str(THRESHOLD)+'_'+TGF+'_'+str(STY)+'to'+str(EDY)+'.pickle', 'wb')
